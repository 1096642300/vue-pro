<template>
  <div class="production-container">
    ...
    >
      ...
      <el-table-column label="图片" prop="img1">
      ...
      <el-table-column prop="proname" label="产品名字" />
      ...
      />
      <el-table-column prop="originprice" label="原件" sortable />
...
import { showdata, updateProFlag } from '@/api/production'
